...
class App {
  ...
  _newWorkout(e) {
    ...
    const posInput = (...inputs) => inputs.every(input => input > 0);
    e.preventDefault();
    ...
    if (type === 'running') {
      ...
      if (
        ...
        !posInput(distance, duration, cadance)
      )
        alert('Input has to be numbers');
    ...
    if (type === 'cycling') {
      ...
      if (
        ...
        !posInput(distance, duration)
      )
        return alert('Input has to be numbers');
  ...
  _renderWorkout(workout) {
    ...
    <div class="workout__details">
      ...
      <span class="workout__unit">spft</span>
    </div>
  </li>`;
